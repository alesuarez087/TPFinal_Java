...
<%if(request.getSession().getAttribute("compraValida")!=null){ %>
	<h4>Su compra se realizó con éxito. Haga <a href="itemTop.jsp">click</a> para continuar</h4>
	<% request.getSession().setAttribute("errorStock", null); 
	} else if(request.getSession().getAttribute("errorStock")!=null){ %>
	<h4>No hay stock para satisfacer su compra. Haga <a href="itemTop.jsp">click</a> para continuar</h4>
	<% request.getSession().setAttribute("errorStock", null); }
