		...
		<form role="form" action="srvItem" method="post" id="formTabla"
			...
			%>
				...
				<tr>
					...
					<td colspan=2><input type="text" readonly class="form-control"
						id="tituloItem" name="tituloItem"
						value="<%if(request.getAttribute("artistaItem")!=null){%><%=request.getAttribute("artistaItem") %><% }%>"
						size="55"></td>
				</tr>
				<tr>
					...
					<td colspan=2><input type="text" readonly class="form-control"
						id="tituloItem" name="tituloItem"
						value="<%if(request.getAttribute("tipoDisco")!=null){%><%=request.getAttribute("tipoDisco") %><% }%>"
						size="55"></td>
				</tr>
				<tr>
					<td><b>Precio:</b></td>
					<td><input type="text" readonly class="form-control"
						id="precioItem" name="precioItem"
						value="<%if(request.getAttribute("precioItem")!=null){%><%=request.getAttribute("precioItem") %><% }%>">
					</td>
					<td><input type="text" class="form-control" id="precioNuevo"
						name="precioNuevo" placeholder="Nuevo Precio"></td>
				</tr>
				<tr>
					<td><b>Stock:</b></td>
					<td><input type="text" readonly class="form-control"
						id="stock" name="stock"
						value="<%if(request.getAttribute("stock")!=null){%><%=request.getAttribute("stock") %><% }%>">
					</td>
					<td><input type="text" class="form-control" id="stockAgregado"
						name="stockAgregado" placeholder="Stock a Agregar"></td>
				</tr>
				<tr>
					<td colspan="2">
			...
			<div align="center">
				<input class="btn btn-success" type="submit" value="Guardar"
					id="saveRemarcar" name="saveRemarcar" /> <input
				...
				<tr>
					...
					<form role="form" action="srvItem" method="post" id="botonera"
						...
						<td style="vertical-align: middle"><input type="hidden"
							...
							id="eventRemarcar" name="eventRemarcar" /></td>
					</form>
				</tr>
				<% 	} %>
			</tbody>
